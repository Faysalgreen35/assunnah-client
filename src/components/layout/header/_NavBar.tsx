...
//       <nav className="mx-auto flex max-w-[1280px] items-center justify-center px-1">
//         {navItems.map(item => {
...
//               <Link
//                 href={item.href}
//                 className={`flex items-center gap-0.5 whitespace-nowrap px-1 py-3 text-[11px] font-bold tracking-[0.05em] ${textClass} hover:text-[#a4722c] transition-colors`}
//               >
//                 {item.label}
//                 {hasSubmenu && (
...
//               {hasSubmenu && isOpen && (
//                 <div className={`absolute left-0 right-0 top-full z-50 ${isDark ? "bg-[#1a2655]" : "bg-white"} shadow-2xl border-t ${isDark ? "border-[#2a3a6a]" : "border-[#ebebeb]"}`}>
//                   <div className={`mx-auto max-w-[1600px] px-8 py-8 flex gap-8 items-start`}>
...
//                         </div>
//                       ) : (
//                         // Multiple columns for more than 4 items
